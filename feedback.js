    ...
    <div>
      ...
      <div className="container mt-5">
        ...
        <form action="/feedback" method="post">
          ...
          {/* Question 4 */}
          <div className="mb-3">
            <label htmlFor="features_valuable">4. What features of DolFin do you find most valuable?</label>
          ...
          {/* Question 5 */}
          <div className="mb-3">
            <label htmlFor="competitors_do_well">5. What do competitors' products do well in comparison to DolFin?</label>
            <textarea className="form-control" id="competitors_do_well" name="competitors_do_well" rows="3"></textarea>
          </div>

          {/* Question 6 */}
          <div className="mb-3">
            <label htmlFor="similarities">6. What aspects do you find similar between competitors' products and DolFin?</label>
